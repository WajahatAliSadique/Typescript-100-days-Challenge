...
//part 1
//Print a PersonName
personName = "Hi Wajahat You Like TypeScript";
...
//Question 2
let Names = ["Wajahat Ali", "Ahmed", "Usman Ali", "Anus", "Usaid"];
for (let i = 0; i < Names.length; i++) {
    console.log(Names[i]);
}
//Question 3
for (let i = 0; i < Names.length; i++) {
    console.log(`Assalam u Alikum: ${Names[i]} Would you like to learn some "Typescript" today.`);
}
